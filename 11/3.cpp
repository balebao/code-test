...
void getSalesFigures(DivisionData& division) {
    do {
        cout << "Enter the sales figures for " << division.divisionName << " division:\n";
        cout << "First Quarter: ";
        ...
        if (division.firstQuarterSales < 0 || division.secondQuarterSales < 0 ||
            ...
            cout << "Sales figures cannot be negative. Please enter valid sales figures.\n";
        }
...
void displayDivisionData(const DivisionData& division) {
    cout << "\nDivision Name: " << division.divisionName << endl;
